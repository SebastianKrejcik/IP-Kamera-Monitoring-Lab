...
- **Erst simulieren, dann ausrollen.** Die Dummy-Interfaces mit Randomizer-Skript zum Simulieren von Kameraausfällen waren beim Testen hilfreicher als erwartet – ohne sie hätte man Ausfallszenarien nur schwer kontrolliert nachstellen können, gerade bevor überhaupt echte Hardware im Feld genommen werden könnte.
